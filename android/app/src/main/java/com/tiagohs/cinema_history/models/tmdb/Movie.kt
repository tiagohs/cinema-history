...
data class Movie (
	...
	@SerializedName("videos") val videos : MovieVideos,
	@SerializedName("images") val images : MovieImages,
	@SerializedName("keywords") val keywords : KeywordList,
	@SerializedName("releases") val releases : Releases,
	@SerializedName("similar_movies") val similarMovies : SimilarMovies,
